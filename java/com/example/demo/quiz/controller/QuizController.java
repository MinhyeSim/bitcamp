...
public class QuizController {
    public void execute(Scanner scanner){
        ...
        Feb10Controller feb010Controller = new Feb10Controller();

        while (true){
            System.out.println("[서브메뉴] 0)exit 1)2월 6일 2)2월 7일 3)2월 8일 4)2월 10일");
            switch (scanner.next()){
                case "0":
                ...
                case "4" : feb010Controller.execute(scanner); break;
                case "5" : break;
                default:
